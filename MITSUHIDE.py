...
listApp = [
	"CHROMEOS\t2.1.5\tEzMITSUHIDE\t11.2.5", 
	"DESKTOPWIN\t5.9.2\tEzMITSUHIDE\t11.2.5", 
	"DESKTOPMAC\t5.9.2\tEzMITSUHIDE\t11.2.5", 
	"IOSIPAD\t8.12.2\tEzMITSUHIDE\t11.2.5", 
	"WIN10\t5.5.5\tEzMITSUHIDE\t11.2.5"
]
try:
	for app in listApp:
		try:
					...
					if msg.contentType == 0:
						if cmd == "logout":
							...
							for contact in contacts:
								client.sendMessage(contact, "[ Group Broadcast ]\n{}".format(str(txt)))
